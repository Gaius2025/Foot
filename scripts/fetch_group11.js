// scripts/fetch_group11.js
// Analyse Group 11 Volley : Top 3 à domicile + dernier match perdu → envoi au VPS
...
const TABLE_PATH = path.join(__dirname, '../tables/table11.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 11 VolleyBall...');
  ...
  try {
    ...
    console.error('❌ Erreur lecture table11.json :', err.message);
    process.exit(2);
  }
...
console.log(`   ✅ ${matchesTomorrow.length} match(s) Top3 à domicile à venir.`);
  ...
  await browser.close();
  console.log('\n🏁 Fin du script Group 11 VolleyBall.');
})();
