...
// Analyse Group 4 : Top 3 à domicile + dernier match perdu → envoi au VPS
...
const TABLE_PATH = path.join(__dirname, '../tables/table4.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 4...');
