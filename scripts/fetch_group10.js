// scripts/fetch_group10.js
// Analyse Group 10 Basket : Top 3 à domicile + dernier match perdu → envoi au VPS
// Usage : node scripts/fetch_group10.js
...
const TABLE_PATH = path.join(__dirname, '../tables/table10.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 10 Basket...');
  ...
  try {
    ...
    console.error('❌ Erreur lecture table10.json :', err.message);
    process.exit(2);
  }
