// scripts/fetch_group9.js
// Analyse Group 9 : Top 3 à domicile + dernier match perdu → envoi au VPS
...
const TABLE_PATH = path.join(__dirname, '../tables/table9.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 9...');
