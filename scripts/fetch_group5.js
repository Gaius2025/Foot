...
// Analyse Group 5 : Top 3 à domicile + dernier match perdu → envoi au VPS
// Usage : node scripts/fetch_group5.js
...
const TABLE_PATH = path.join(__dirname, '../tables/table5.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 5...');
