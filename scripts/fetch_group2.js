// scripts/fetch_group2.js
// Analyse Group 2 : Top 3 à domicile + dernier match perdu → envoi au VPS
...
const TABLE_PATH = path.join(__dirname, '../tables/table2.json');
