// scripts/fetch_group7.js
// Analyse Group 7 : Top 3 à domicile + dernier match perdu → envoi au VPS
...
const TABLE_PATH = path.join(__dirname, '../tables/table7.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 7...');
