...
const TABLE_PATH = path.join(__dirname, '../tables/table8.json');
...
// -----------------------------------------------------------------------------
(async () => {
  console.log('🚀 Démarrage du script Group 8...');
